...
public class insertItem extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        DAO dao = new DAO();
        ArrayList<Item> list = dao.getItem();
        boolean check = dao.insertItem(list.get(list.size()-1).getID()+1, itemName, itemPrice, Description, Introduction, Quantity, TypeID, Img);

            String a = "Insert fail!!!";
            if (true) {
                a = "Insert Successfully!!!";
            }
