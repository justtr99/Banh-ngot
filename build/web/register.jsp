<%-- 
    Document   : register
    Created on : Oct 8, 2023, 2:51:35 PM
    Author     : Admin
--%>
...
<div class="login-form">
    <form action="controller">
        <h2 class="inner text-center breadcrumb-content breadcrumb-big">ĐĂNG KÝ</h2> 
        <hr>
        <div class="form-group">
            <input type="text" class="form-control" placeholder="Tài khoản" required="required" name="txtnewUsername">
        </div>
        <div class="form-group">
            <input type="text" class="form-control" placeholder="Email" required="required" name="txtnewEmail">
        </div>
        <div class="form-group">
            <input type="password" class="form-control" placeholder="Mật khẩu" required="required" name="txtnewPassword">
        </div>
        <div class="form-group">
            <input type="password" class="form-control" placeholder="Nhập lại mật khẩu" required="required" name="txt2newPassword">
        </div>
        
        <%
            String an=(String)request.getAttribute("AN");
            if(an!=null){
            String check=(String)request.getAttribute("CHECKREGISTER");
            if(check!=null){
        %>
        <p><%= check %></p>
        <%}}%>
        ...
        <div class="form-group">
            <button name="luaChon" value="Register" type="submit" class="btn btn-primary btn-block" style="background-color: #BE9E72; border: 2px solid #BE9E72;">Đăng ký</button>
        </div>
        <a style="color: #BE9E72;margin-left: 110px;" href="login.jsp" target="target">Đăng nhập</a>
        <hr>      
    </form>
