...
<!--                    ::after-->
    ...
    <div class="sanpham1">
        ...
        <h3 style=" font-weight: 700;font-family: cursive;color: black;margin-left: 177px;">New In</h3>
    ...
    <%
        ...
        if(listItem!=null){ 
        int m=0;
        for(int j=listItem.size()-1;j>=0;j--){
        if(m<8){
    %>
    <div class=" col-md-6  items" style="display: flex;width: 541px;height: 176px;">
        <div>
        <a class="show-div-link" href="" style="width: 381px;height: 176px; text-decoration: none;">
            <div style="width: 381px;height: 176px;color: black;    font-family: cursive;">   
            <p style="font-weight: 700;"><%= listItem.get(j).getItemName() %></p>
            <p style="height: 85.2px;    font-size: 15px;"><%= listItem.get(j).getIntroduction() %></p>
             <div style="display:flex">
        
        <p style="font-size: 18px;font-weight: 700;"><%= Math.round(listItem.get(j).getPrice()  )%><%="đ"%></p>
        <%if(listItem.get(j).getQuantity()>0){%>
        <p style="margin-left: 200px;">Còn lại: <%=listItem.get(j).getQuantity()%></p>
        <%} else{%>
        ...
        <div class="overlay" style="z-index:2000">
            <div class="centered-div" style="padding: 0px;">
                ...
                <div class="scrollable-content" style="height: 550px;width:600px;border-radius: 5px;border-radius: 5px;;">
                   <img src=<%= listItem.get(j).getImg()%> style="width: 100%;" alt="">
                <div style="margin-left: 15px;"> 
                   <p class="text4"><%= listItem.get(j).getItemName() %></p>
                   <p class="text4" style="font-size: 19px;"><%= Math.round(listItem.get(j).getPrice()  )%><%="đ"%></p>
                <form action="insertCart" >
                    <input type="hidden" name="IdCart" value="<%=listItem.get(j).getID()%>">
                    <input type="hidden" name="Type" value="<%=6%>">
                   <input style="width: 192.8px;"  class="inputnumber" type="number" name="Inputnumber" min="1" value="1" max="<%=listItem.get(j).getQuantity()%>" >
                <p style="margin-top: 20px;">Mô tả</p>
                <p style="font-size: 18px;
                font-family: monospace;color: black"><%= listItem.get(j).getDescription()  %></p>
            </div>
                </div>
         ...
         <div style="margin-left: 15px;">
        <a href=""><img style="width: 124px;height: 124px;" src=<%= listItem.get(j).getImg() %> alt=""></a>
        </div>
...
<div class="sanpham1">
    <div style="display: flex;">
    <h3 style=" font-weight: 700;font-family: cursive;color: black;margin-left: 177px;">GIFTSET</h3>
    <div style="margin-left: 814px;margin-top: 19px;display: flex;"> 
</div>
</div>
    <div class="container">
...
<div class="sanpham1">
    <div style="display: flex;">
    <h3 style=" font-weight: 700;font-family: cursive;color: black;margin-left: 177px;">Bánh lẻ</h3>
    <div style="margin-left: 814px;margin-top: 19px;display: flex;"> 
...
<div class="sanpham1">
    <div style="display: flex;">
    <h3 style=" font-weight: 700;font-family: cursive;color: black;margin-left: 177px;">Đồ uống</h3>
    <div style="margin-left: 814px;margin-top: 19px;display: flex;"> 
