...
<div class="sanpham1">
    ...
    <div class="dropdown" style="border: solid 1px black;width: 125px;height: 30px;text-align: center;">
        ...
        <div class="dropdown-content">
            <a style="color: black;font-family: cursive;width: 170px;" href="sapxep?luachon=thapDenCao&url=doUong.jsp">Giá từ thấp tới cao</a>
            <a style="color: black;font-family: cursive;width: 170px;" href="sapxep?luachon=caoDenThap&url=doUong.jsp">Giá từ cao tới thấp</a>
            <a style="color: black;font-family: cursive;width: 170px;" href="sapxep?luachon=cuNhat&url=doUong.jsp">Mới nhất</a>
            <a style="color: black;font-family: cursive;width: 170px;" href="sapxep?luachon=moiNhat&url=doUong.jsp">Cũ nhất</a>
        </div>
    </div>
</div>
</div>
